...
def value_of_ace(card_one, card_two):
    ...
    # Si hay al menos un as en la mano, devolver 11.
    if card_one == 'A' or card_two == 'A':
        return 1

    # Si la suma de las cartas es mayor que 10, devolver 1.
...
def is_blackjack(card_one, card_two):
    ...
    if card_one_value == 1 and card_two_value == 10 or card_one_value == 10 and card_two_value == 1:
        return True
    else:
        return False
